...
/* 图片 */
import erji from '../../static/images/xiangqing/erji.png';
import aixing from '../../static/images/xiangqing/aixin.png';
import shopchar from '../../static/images/xiangqing/gouwuche.png';
...
class Xiangqing extends React.Component {
	...
	render() {
		let { addr, floor, fnagxing, mianji, mony, type, years, zhuangxiu, direction } = this.state.hous_info;
		return (
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(Xiangqing));
